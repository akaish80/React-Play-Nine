...
var ButtonFrame = React.createClass({
	...
	switch(correct){
		case true:
			button = (
				<button className="btn btn-success btn-lg" onClick={this.props.acceptAnswer}><span className="glyphicon glyphicon-ok"></span></button>
			);
			break;
		case false:
			button = (
				<button className="btn btn-danger btn-lg"><span className="glyphicon glyphicon-remove"></span></button>
			);
			break;
		default:
	...
	render: function(){
		return (
			<div className="well text-center">
				...
				<button className="btn btn-default" onClick={this.click.resetGame}>Play again</button>
			</div>
		);
	}
});
